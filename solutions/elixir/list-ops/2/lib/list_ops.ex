defmodule ListOps do
  ...
  defp map([], _fun, acc), do: acc |> reverse()

  defp map([head | rest], fun, acc) do
  ...
  defp filter([], _function, result), do: result |> reverse()

  defp filter([head | rest], function, result) do
    if function.(head) do
